...
#### Set up initial model parameters [x]
...
#### Run the water offset solver and calculate the retreat rates [x: batch and water_level_solver]
...
- Mamontovy Khayata:  make_mask_with_extra_figures_single_year_sicn_threshold_ERAI_bykovsky_mamontovy_hayata.py
