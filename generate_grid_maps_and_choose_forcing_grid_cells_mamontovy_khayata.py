...
year = 2011 # choose any year where the reanalysis data is available, just need an example file that has the grid.
...
np.save(basepath + 'Mamontovy_Khayata/lat_site_ERAI_mamontovy.npy',lat_site_ERAI)
np.save(basepath + 'Mamontovy_Khayata/lon_site_ERAI_mamontovy.npy',lon_site_ERAI)
...
np.save(basepath + 'Mamontovy_Khayata/lat_offshore_site_ERAI_mamontovy_hayata.npy',lat_offshore_site_ERAI_mamontovy_hayata)
np.save(basepath + 'Mamontovy_Khayata/lon_offshore_site_ERAI_mamontovy_hayata.npy',lon_offshore_site_ERAI_mamontovy_hayata)
...
plt.savefig(plot_basepath + 'study_sites/grid_mamontovy_khayata' + '.png', bbox_inches='tight', dpi=300)
plt.show()
