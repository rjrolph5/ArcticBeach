...
plot_path = basepath + 'plots/study_sites/'
...
#np.save('/home/rrolph/erosion_model/input_data/storm_surge/Drew_Point/lat_offshore_site_ERAI_Drew_Point.npy',lat_offshore_site_ERAI)
#np.save('/home/rrolph/erosion_model/input_data/storm_surge/Drew_Point/lon_offshore_site_ERAI_Drew_Point.npy',lon_offshore_site_ERAI)
...
### load the Mamontovy Khayata site
lat_site_ERAI_mamontovy = np.load(basepath + 'input_data/storm_surge/Mamontovy_Khayata/lat_site_ERAI_mamontovy.npy')
lon_site_ERAI_mamontovy = np.load(basepath + 'input_data/storm_surge/Mamontovy_Khayata/lon_site_ERAI_mamontovy.npy')

px_site_mamontovy, py_site_mamontovy = m(lon_site_ERAI_mamontovy, lat_site_ERAI_mamontovy)
px_site_mamontovy_label, py_site_mamontovy_label = m(lon_site_ERAI_mamontovy + 16, lat_site_ERAI_mamontovy - 6)
...
m.scatter(px_site_mamontovy, py_site_mamontovy, marker='o', s=100, color='r', zorder=5)
...
plt.savefig(plot_path + 'pan_arctic_both_sites' + '.png', bbox_inches='tight', dpi=300)
plt.show()
...
plt.savefig(plot_path + 'grid_drew_point' + '.png', bbox_inches='tight', dpi=300)
plt.show()
'''
